            ...
            try
            {
                ...
                try
                {
                    switch (Data[0])
                    {
                        ...
                        case "GET_BIN_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetBinData(Data[1]);
                            objSecurity = null;
                            break;

                        case "SAVE_BIN_REJECTION_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SaveBinRejectionData(Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;

                        case "SAVE_PART_REJECTION_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SavePartRejectionData(Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;

                        case "SAVE_PART_REJECTION_DATA_NON_BARCODE":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SavePartRejectionDataNonBarcode(Data[1], int.Parse(Data[2]), Data[3], Data[4]);
                            objSecurity = null;
                            break;

                        case "GET_FRACTION_NEW_BIN_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetFractionNewBinData(Data[1]);
                            objSecurity = null;
                            break;

                        case "SAVE_FRACTION_NEW_BIN_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SaveFractionNewBinData(Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;

                        case "GET_FRACTION_BIN_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetFractionBinData(Data[1]);
                            objSecurity = null;
                            break;

                        case "SAVE_FRACTION_BIN_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SaveFractionBinData(Data[1], Data[2],Convert.ToInt32(Data[3]),Data[4]);
                            objSecurity = null;
                            break;

                        case "GET_FGFEEDING_BIN_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetFgFeedingBinData(Data[1]);
                            objSecurity = null;
                            break;

                        case "SAVE_FGFEEDING_BIN_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SaveFgFeedingBinData(Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;

                        case "GET_PICK_PICKLIST_NO":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetFgPickPickListNo();
                            objSecurity = null;
                            break;

                        case "GET_PICK_PICKLIST_NO_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetFgPickPickListNoData(Data[1]);
                            objSecurity = null;
                            break;

                        case "GET_PICK_PICKLIST_BIN_LOCATION":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetFgPickPickListNoBinLocationData(Data[1]);
                            objSecurity = null;
                            break;

                        case "FGPICK_VALIDATE_BIN":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.FgPickingValidateBin(Data[1],Data[2], Data[3], Data[4], Data[5]);
                            objSecurity = null;
                            break;

                        case "FGPICK_SAVE_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.FgPickingSaveBin(Data[1], Data[2], Data[3], Data[4], Data[5], Convert.ToBoolean(Data[6]));
                            objSecurity = null;
                            break;

                        case "GET_DIRECT_DISPATCH_TRUCK_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetDirectDispatchTruckData(Data[1], Data[2]);
                            objSecurity = null;
                            break;

                        case "SAVE_DIRECT_DISPATCH_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SaveDirectDispatch(Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;

                        //Added By Akhilesh on 11-01-2021
                        case "COMPLETE_DISPATCH_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.SaveCompleteDispatch(Data[1], Data[2]);
                            objSecurity = null;
                            break;
                        //End

                        case "GET_DIS_PICKLIST_NO":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetDispatchPickListNo();
                            objSecurity = null;
                            break;

                        case "GET_DIS_PICKLIST_NO_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetDispatchPickListNoData(Data[1]);
                            objSecurity = null;
                            break;

                        case "DIS_SAVE_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.DispatchSaveBin(Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;

                        //Added By Akhilesh on 11-01-2021
                        case "CHECK_BIN_BARCODE":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.CheckBinBarcode(Data[1]);
                            objSecurity = null;
                            break;
                        // End
                        ...
                        case "GET_LINE_NO":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetLineNo();
                            objSecurity = null;
                            break;

                        case "CHILD_MAPPED_SAVE_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.ChildMappedSaveData(Data[0],Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;

                        case "GET_MAPPED_DATA":
                            objSecurity = new clsSecurity();
                            Response = objSecurity.GetGET_MAPPED_DATA(Data[0], Data[1], Data[2], Data[3]);
                            objSecurity = null;
                            break;
