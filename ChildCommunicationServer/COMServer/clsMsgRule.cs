...
{
    public enum EnumDbType { SELECT, INSERT, UPDATE, DELETE, SELECTBYID, SEARCH, VALIDATEUSER, UPDATEPASSWORD, KANBAN, PART, REJECT, BIN, REJECT_NONBARCODE, FRACTION, PICK_DETAILS, COMPLETE , GET_LINE };
