...
namespace SatoScanningApp
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        Vibrator vibrator;
        Button btnRejectWithPart, btnRejectWithOutPart, btnFractionWithPart, btnFractionWithOutPart, btnFgFeeding, btnFGPicking, btnDirectDispatch, btnAfterPickingDispatch, btnChildMapping;
        public MainActivity()
        {
            try
            {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                btnChildMapping = FindViewById<Button>(Resource.Id.btnChildMapping);
                btnChildMapping.Click += btnChildMapping_Click;
        ...
        private void btnChildMapping_Click(object sender, EventArgs e)
        {
            try
            {
                OpenActivity(typeof(ChildPartMappingActivity));
            }
            catch (Exception ex)
            {
                clsGLB.ShowMessage(ex.Message, this, MessageTitle.ERROR);
