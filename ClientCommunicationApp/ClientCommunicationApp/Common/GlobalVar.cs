...
namespace ClientCommunicationApp.Common
{
    ...
    public class GlobalVar
    {
        ...
        public static string mPLC_IP = ConfigurationManager.ConnectionStrings["PLC_IP"].ConnectionString;
        public static string mPLC_PORT = ConfigurationManager.ConnectionStrings["PLC_PORT"].ConnectionString;
        public static string mPrinterIP = ConfigurationManager.ConnectionStrings["PrinterIP"].ConnectionString;
